...
null;this.eyeSep=void 0===a?.064:a;this.loffset=new d.Vector2;this.roffset=new d.Vector2}function P(a,b,c){a=void 0===a?16777215:a;b=void 0===b?!0:b;c=void 0===c?1500:c;this.dpr=window.devicePixelRatio;var e=this.createCanvas(),g=e.canvas;e=e.context;var h=new d.SpriteMaterial({color:a,map:this.createCanvasTexture(g)});d.Sprite.call(this,h);this.canvasWidth=g.width;this.canvasHeight=g.height;this.context=e;this.color=a instanceof d.Color?a:new d.Color(a);this.autoSelect=b;this.dwellTime=c;this.rippleDuration=
500;this.position.z=-10;this.center.set(.5,.5);this.scale.set(.5,.5,1);this.callback=this.timerId=this.startTimestamp=null;this.frustumCulled=!1;this.updateCanvasArcByProgress(0)}function y(a,b,c){a=void 0===a?300:a;b=b||t.Info;d.Sprite.call(this);this.type="infospot";this.animated=void 0!==c?c:!0;this.frustumCulled=this.isHovering=!1;this.cursorStyle=this.toPanorama=this.element=null;this.mode=r.NORMAL;this.scale.set(a,a,1);this.rotation.y=Math.PI;this.container=null;this.originalRaycast=this.raycast;
this.HANDLER_FOCUS=null;this.material.side=d.DoubleSide;this.material.depthTest=!1;this.material.transparent=!0;this.material.opacity=0;this.scaleUpAnimation=new n.Tween;this.scaleDownAnimation=new n.Tween;c=function(b){if(this.material){var e=b.image.width/b.image.height,c=new d.Vector3;b.image.width=b.image.naturalWidth||64;b.image.height=b.image.naturalHeight||64;this.scale.set(e*a,a,1);c.copy(this.scale);this.scaleUpAnimation=(new n.Tween(this.scale)).to({x:1.3*c.x,y:1.3*c.y},500).easing(n.Easing.Elastic.Out);
this.scaleDownAnimation=(new n.Tween(this.scale)).to({x:c.x,y:c.y},500).easing(n.Easing.Elastic.Out);this.material.map=b;this.material.needsUpdate=!0}}.bind(this);this.showAnimation=(new n.Tween(this.material)).to({opacity:1},500).onStart(this.enableRaycast.bind(this,!0)).easing(n.Easing.Quartic.Out);this.hideAnimation=(new n.Tween(this.material)).to({opacity:0},500).onStart(this.enableRaycast.bind(this,!1)).easing(n.Easing.Quartic.Out);this.addEventListener("click",this.onClick);this.addEventListener("hover",
this.onHover);this.addEventListener("hoverenter",this.onHoverStart);this.addEventListener("hoverleave",this.onHoverEnd);this.addEventListener("panolens-dual-eye-effect",this.onDualEyeEffect);this.addEventListener("panolens-container",this.setContainer.bind(this));this.addEventListener("dismiss",this.onDismiss);this.addEventListener("panolens-infospot-focus",this.setFocusMethod);I.load(b,c)}function J(a){a||console.warn("PANOLENS.Widget: No container specified");d.EventDispatcher.call(this);this.DEFAULT_TRANSITION=
"all 0.27s ease";this.TOUCH_ENABLED=!!("ontouchstart"in window||window.DocumentTouch&&document instanceof DocumentTouch);this.PREVENT_EVENT_HANDLER=function(a){a.preventDefault();a.stopPropagation()};this.container=a;this.mask=this.activeSubMenu=this.activeMainItem=this.mainMenu=this.settingElement=this.videoElement=this.fullscreenElement=this.barElement=null}function m(){this.edgeLength=1E4;d.Mesh.call(this,this.createGeometry(this.edgeLength),this.createMaterial());this.type="panorama";this.ImageQualityLow=
1;this.ImageQualityFair=2;this.ImageQualityMedium=3;this.ImageQualityHigh=4;this.ImageQualitySuperHigh=5;this.animationDuration=1E3;this.defaultInfospotSize=350;this.container=void 0;this.loaded=!1;this.linkedSpots=[];this.isInfospotVisible=!1;this.linkingImageScale=this.linkingImageURL=void 0;this.renderOrder=-1;this.active=!1;this.infospotAnimation=(new n.Tween(this)).to({},this.animationDuration/2);this.addEventListener("load",this.fadeIn.bind(this));this.addEventListener("panolens-container",
this.setContainer.bind(this));this.addEventListener("click",this.onClick.bind(this));this.setupTransitions()}function u(a){m.call(this);this.src=a;this.type="image_panorama"}function R(){m.call(this);this.type="empty_panorama"}function K(a){a=void 0===a?[]:a;m.call(this);this.images=a;this.type="cube_panorama"}function S(){for(var a=[],b=0;6>b;b++)a.push(t.WhiteTile);K.call(this,a);this.type="basic_panorama"}function z(a,b){b=void 0===b?{}:b;m.call(this);this.src=a;this.options=Object.assign({videoElement:document.createElement("video"),
...
new d.Quaternion;this.vectorX=new d.Vector3(1,0,0);this.vectorY=new d.Vector3(0,1,0);this.type="little_planet";this.addEventListener("window-resize",this.onWindowResize)}function ba(a){B.call(this,"image",a);this.type="image_little_planet"}function L(a){m.call(this);this.media=new Y(a);this.type="camera_panorama";this.addEventListener("enter",this.start.bind(this));this.addEventListener("leave",this.stop.bind(this));this.addEventListener("panolens-container",this.onPanolensContainer.bind(this));this.addEventListener("panolens-scene",
this.onPanolensScene.bind(this))}function M(a,b){b=void 0===b?new F:b;u.call(this,a);this.stereo=b;this.type="stereo_image_panorama"}function T(a,b,c){b=void 0===b?{}:b;c=void 0===c?new F:c;z.call(this,a,b);this.stereo=c;this.type="stereo_video_panorama"}function ca(a,b){function c(a){U=!1;N=O=0;if(!1!==f.enabled){a.preventDefault();if(a.button===f.mouseButtons.ORBIT){if(!0===f.noRotate)return;w=v.ROTATE;D.set(a.clientX,a.clientY)}else if(a.button===f.mouseButtons.ZOOM){if(!0===f.noZoom)return;w=
v.DOLLY;u.set(a.clientX,a.clientY)}else if(a.button===f.mouseButtons.PAN){if(!0===f.noPan)return;w=v.PAN;m.set(a.clientX,a.clientY)}w!==v.NONE&&(document.addEventListener("mousemove",e,!1),document.addEventListener("mouseup",g,!1),f.dispatchEvent(R));f.update()}}function e(a){if(!1!==f.enabled){a.preventDefault();var b=f.domElement===document?f.domElement.body:f.domElement;if(w===v.ROTATE){if(!0===f.noRotate)return;k.set(a.clientX,a.clientY);n.subVectors(k,D);f.rotateLeft(2*Math.PI*n.x/b.clientWidth*
f.rotateSpeed);f.rotateUp(2*Math.PI*n.y/b.clientHeight*f.rotateSpeed);D.copy(k);G&&(N=a.clientX-G.clientX,O=a.clientY-G.clientY);G=a}else if(w===v.DOLLY){if(!0===f.noZoom)return;y.set(a.clientX,a.clientY);z.subVectors(y,u);0<z.y?f.dollyIn():0>z.y&&f.dollyOut();u.copy(y)}else if(w===v.PAN){if(!0===f.noPan)return;W.set(a.clientX,a.clientY);r.subVectors(W,m);f.pan(r.x,r.y);m.copy(W)}w!==v.NONE&&f.update()}}function g(){U=!0;G=void 0;!1!==f.enabled&&(document.removeEventListener("mousemove",e,!1),document.removeEventListener("mouseup",
g,!1),f.dispatchEvent(S),w=v.NONE)}function h(a){if(!1!==f.enabled&&!0!==f.noZoom&&w===v.NONE){a.preventDefault();a.stopPropagation();var b=0;void 0!==a.wheelDelta?b=a.wheelDelta:void 0!==a.detail&&(b=-a.detail);0<b?(f.object.fov=f.object.fov<f.maxFov?f.object.fov+1:f.maxFov,f.object.updateProjectionMatrix()):0>b&&(f.object.fov=f.object.fov>f.minFov?f.object.fov-1:f.minFov,f.object.updateProjectionMatrix());f.update();f.dispatchEvent(X);f.dispatchEvent(R);f.dispatchEvent(S)}}function q(a){switch(a.keyCode){case f.keys.UP:I=
!1;break;case f.keys.BOTTOM:J=!1;break;case f.keys.LEFT:L=!1;break;case f.keys.RIGHT:M=!1}}function p(a){if(!1!==f.enabled&&!0!==f.noKeys&&!0!==f.noRotate){switch(a.keyCode){case f.keys.UP:I=!0;break;case f.keys.BOTTOM:J=!0;break;case f.keys.LEFT:L=!0;break;case f.keys.RIGHT:M=!0}if(I||J||L||M)U=!0,I&&(O=-f.rotateSpeed*f.momentumKeydownFactor),J&&(O=f.rotateSpeed*f.momentumKeydownFactor),L&&(N=-f.rotateSpeed*f.momentumKeydownFactor),M&&(N=f.rotateSpeed*f.momentumKeydownFactor)}}function l(a){U=!1;
N=O=0;if(!1!==f.enabled){switch(a.touches.length){case 1:if(!0===f.noRotate)return;w=v.TOUCH_ROTATE;D.set(a.touches[0].pageX,a.touches[0].pageY);break;case 2:if(!0===f.noZoom)return;w=v.TOUCH_DOLLY;var b=a.touches[0].pageX-a.touches[1].pageX;a=a.touches[0].pageY-a.touches[1].pageY;u.set(0,Math.sqrt(b*b+a*a));break;case 3:if(!0===f.noPan)return;w=v.TOUCH_PAN;m.set(a.touches[0].pageX,a.touches[0].pageY);break;default:w=v.NONE}w!==v.NONE&&f.dispatchEvent(R)}}function x(a){if(!1!==f.enabled){a.preventDefault();
a.stopPropagation();var b=f.domElement===document?f.domElement.body:f.domElement;switch(a.touches.length){case 1:if(!0===f.noRotate)break;if(w!==v.TOUCH_ROTATE)break;k.set(a.touches[0].pageX,a.touches[0].pageY);n.subVectors(k,D);f.rotateLeft(2*Math.PI*n.x/b.clientWidth*f.rotateSpeed);f.rotateUp(2*Math.PI*n.y/b.clientHeight*f.rotateSpeed);D.copy(k);G&&(N=a.touches[0].pageX-G.pageX,O=a.touches[0].pageY-G.pageY);G={pageX:a.touches[0].pageX,pageY:a.touches[0].pageY};f.update();break;case 2:if(!0===f.noZoom)break;
...
r.subVectors(W,m);f.pan(r.x,r.y);m.copy(W);f.update();break;default:w=v.NONE}}}function Q(){U=!0;G=void 0;!1!==f.enabled&&(f.dispatchEvent(S),w=v.NONE)}this.object=a;this.domElement=void 0!==b?b:document;this.frameId=null;this.enabled=!0;this.center=this.target=new d.Vector3;this.noZoom=!1;this.zoomSpeed=1;this.minDistance=0;this.maxDistance=Infinity;this.minZoom=0;this.maxZoom=Infinity;this.noRotate=!1;this.rotateSpeed=-.15;this.noPan=!0;this.keyPanSpeed=7;this.autoRotate=!1;this.autoRotateSpeed=
2;this.minPolarAngle=0;this.maxPolarAngle=Math.PI;this.momentumDampingFactor=.9;this.momentumScalingFactor=-.005;this.momentumKeydownFactor=20;this.minFov=30;this.maxFov=120;this.minAzimuthAngle=-Infinity;this.maxAzimuthAngle=Infinity;this.noKeys=!1;this.keys={LEFT:37,UP:38,RIGHT:39,BOTTOM:40};this.mouseButtons={ORBIT:d.MOUSE.LEFT,ZOOM:d.MOUSE.MIDDLE,PAN:d.MOUSE.RIGHT};var f=this,D=new d.Vector2,k=new d.Vector2,n=new d.Vector2,m=new d.Vector2,W=new d.Vector2,r=new d.Vector2,t=new d.Vector3,A=new d.Vector3,
u=new d.Vector2,y=new d.Vector2,z=new d.Vector2,V=0,H=0,B=0,C=0,E=1,F=new d.Vector3,K=new d.Vector3,P=new d.Quaternion,N=0,O=0,G,U=!1,I,J,L,M,v={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_DOLLY:4,TOUCH_PAN:5},w=v.NONE;this.target0=this.target.clone();this.position0=this.object.position.clone();this.zoom0=this.object.zoom;var T=(new d.Quaternion).setFromUnitVectors(a.up,new d.Vector3(0,1,0)),Y=T.clone().inverse(),X={type:"change"},R={type:"start"},S={type:"end"};this.setLastQuaternion=function(a){P.copy(a);
f.object.quaternion.copy(a)};this.getLastPosition=function(){return K};this.rotateLeft=function(a){void 0===a&&(a=2*Math.PI/60/60*f.autoRotateSpeed);C-=a};this.rotateUp=function(a){void 0===a&&(a=2*Math.PI/60/60*f.autoRotateSpeed);B-=a};this.panLeft=function(a){var b=this.object.matrix.elements;t.set(b[0],b[1],b[2]);t.multiplyScalar(-a);F.add(t)};this.panUp=function(a){var b=this.object.matrix.elements;t.set(b[4],b[5],b[6]);t.multiplyScalar(a);F.add(t)};this.pan=function(a,b){var e=f.domElement===
...
A.z);H=Math.atan2(Math.sqrt(A.x*A.x+A.z*A.z),A.y);this.autoRotate&&w===v.NONE&&this.rotateLeft(2*Math.PI/60/60*f.autoRotateSpeed);this.momentum();V+=C;H+=B;V=Math.max(this.minAzimuthAngle,Math.min(this.maxAzimuthAngle,V));H=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,H));H=Math.max(1E-7,Math.min(Math.PI-1E-7,H));var e=A.length()*E;e=Math.max(this.minDistance,Math.min(this.maxDistance,e));this.target.add(F);A.x=e*Math.sin(H)*Math.sin(V);A.y=e*Math.cos(H);A.z=e*Math.sin(H)*Math.cos(V);A.applyQuaternion(Y);
b.copy(this.target).add(A);this.object.lookAt(this.target);B=C=0;E=1;F.set(0,0,0);if(1E-7<K.distanceToSquared(this.object.position)||1E-7<8*(1-P.dot(this.object.quaternion)))!0!==a&&this.dispatchEvent(X),K.copy(this.object.position),P.copy(this.object.quaternion)};this.reset=function(){w=v.NONE;this.target.copy(this.target0);this.object.position.copy(this.position0);this.object.zoom=this.zoom0;this.object.updateProjectionMatrix();this.dispatchEvent(X);this.update()};this.getPolarAngle=function(){return H};
this.getAzimuthalAngle=function(){return V};this.dispose=function(){this.domElement.removeEventListener("mousedown",c);this.domElement.removeEventListener("mousewheel",h);this.domElement.removeEventListener("DOMMouseScroll",h);this.domElement.removeEventListener("touchstart",l);this.domElement.removeEventListener("touchend",Q);this.domElement.removeEventListener("touchmove",x);window.removeEventListener("keyup",q);window.removeEventListener("keydown",p)};this.domElement.addEventListener("mousedown",
c,{passive:!1});this.domElement.addEventListener("mousewheel",h,{passive:!1});this.domElement.addEventListener("DOMMouseScroll",h,{passive:!1});this.domElement.addEventListener("touchstart",l,{passive:!1});this.domElement.addEventListener("touchend",Q,{passive:!1});this.domElement.addEventListener("touchmove",x,{passive:!1});window.addEventListener("keyup",q,{passive:!1});window.addEventListener("keydown",p,{passive:!1});this.update()}function da(a,b){var c=this,e={type:"change"},g=0,h=0,q=0,p=0;
this.camera=a;this.camera.rotation.reorder("YXZ");this.domElement=void 0!==b?b:document;this.enabled=!0;this.deviceOrientation={};this.alphaOffsetAngle=this.alpha=this.screenOrientation=0;var l=function(a){c.deviceOrientation=a},x=function(){c.screenOrientation=window.orientation||0},k=function(a){a.preventDefault();a.stopPropagation();q=a.touches[0].pageX;p=a.touches[0].pageY},f=function(a){a.preventDefault();a.stopPropagation();g+=d.Math.degToRad((a.touches[0].pageX-q)/4);h+=d.Math.degToRad((p-
a.touches[0].pageY)/4);c.updateAlphaOffsetAngle(g);q=a.touches[0].pageX;p=a.touches[0].pageY};this.connect=function(){x();window.addEventListener("orientationchange",x,{passive:!0});window.addEventListener("deviceorientation",l,{passive:!0});window.addEventListener("deviceorientation",this.update.bind(this),{passive:!0});c.domElement.addEventListener("touchstart",k,{passive:!1});c.domElement.addEventListener("touchmove",f,{passive:!1});c.enabled=!0};this.disconnect=function(){window.removeEventListener("orientationchange",
x,!1);window.removeEventListener("deviceorientation",l,!1);window.removeEventListener("deviceorientation",this.update.bind(this),!1);c.domElement.removeEventListener("touchstart",k,!1);c.domElement.removeEventListener("touchmove",f,!1);c.enabled=!1};this.update=function(a){if(!1!==c.enabled){var b=c.deviceOrientation.alpha?d.Math.degToRad(c.deviceOrientation.alpha)+c.alphaOffsetAngle:0,g=c.deviceOrientation.beta?d.Math.degToRad(c.deviceOrientation.beta):0,f=c.deviceOrientation.gamma?d.Math.degToRad(c.deviceOrientation.gamma):
0,q=c.screenOrientation?d.Math.degToRad(c.screenOrientation):0,p=c.camera.quaternion,l=new d.Vector3(0,0,1),D=new d.Euler,x=new d.Quaternion,k=new d.Quaternion(-Math.sqrt(.5),0,0,Math.sqrt(.5)),Q=new d.Quaternion,n=new d.Quaternion;if(0==c.screenOrientation){var m=new d.Vector3(1,0,0);Q.setFromAxisAngle(m,-h)}else 180==c.screenOrientation?(m=new d.Vector3(1,0,0),Q.setFromAxisAngle(m,h)):90==c.screenOrientation?(m=new d.Vector3(0,1,0),Q.setFromAxisAngle(m,h)):-90==c.screenOrientation&&(m=new d.Vector3(0,
1,0),Q.setFromAxisAngle(m,-h));k.multiply(Q);k.multiply(n);D.set(g,b,-f,"YXZ");p.setFromEuler(D);p.multiply(k);p.multiply(x.setFromAxisAngle(l,-q));c.alpha=b;!0!==a&&c.dispatchEvent(e)}};this.updateAlphaOffsetAngle=function(a){this.alphaOffsetAngle=a;this.update()};this.dispose=function(){this.disconnect()};this.connect()}function ia(a){var b=new d.OrthographicCamera(-1,1,1,-1,0,1),c=new d.Scene,e=new d.StereoCamera;e.aspect=.5;var g=new d.WebGLRenderTarget(512,512,{minFilter:d.LinearFilter,magFilter:d.NearestFilter,
format:d.RGBAFormat});g.scissorTest=!0;g.texture.generateMipmaps=!1;var h=new d.Vector2(.441,.156),q=(new d.PlaneBufferGeometry(1,1,10,20)).removeAttribute("normal").toNonIndexed(),p=q.attributes.position.array,l=q.attributes.uv.array;q.attributes.position.count*=2;q.attributes.uv.count*=2;var x=new Float32Array(2*p.length);x.set(p);x.set(p,p.length);var k=new Float32Array(2*l.length);k.set(l);k.set(l,l.length);l=new d.Vector2;p=p.length/3;for(var f=0,D=x.length/3;f<D;f++){l.x=x[3*f];l.y=x[3*f+1];
var m=l.dot(l);m=1.5+(h.x+h.y*m)*m;var n=f<p?0:1;x[3*f]=l.x/m*1.5-.5+n;x[3*f+1]=l.y/m*3;k[2*f]=.5*(k[2*f]+n)}q.attributes.position.array=x;q.attributes.uv.array=k;h=new d.MeshBasicMaterial({map:g.texture});q=new d.Mesh(q,h);c.add(q);this.setSize=function(b,e){a.setSize(b,e);var c=a.getPixelRatio();g.setSize(b*c,e*c)};this.render=function(h,f){h.updateMatrixWorld();null===f.parent&&f.updateMatrixWorld();e.update(f);f=g.width/2;var d=g.height;a.autoClear&&a.clear();g.scissor.set(0,0,f,d);g.viewport.set(0,
0,f,d);a.setRenderTarget(g);a.render(h,e.cameraL);a.clearDepth();g.scissor.set(f,0,f,d);g.viewport.set(f,0,f,d);a.setRenderTarget(g);a.render(h,e.cameraR);a.clearDepth();a.setRenderTarget(null);a.render(c,b)}}function ea(a){a=a||{};a.controlBar=void 0!==a.controlBar?a.controlBar:!0;a.controlButtons=a.controlButtons||["fullscreen","setting","video"];a.autoHideControlBar=void 0!==a.autoHideControlBar?a.autoHideControlBar:!1;a.autoHideInfospot=void 0!==a.autoHideInfospot?a.autoHideInfospot:!0;a.horizontalView=
...
fa={load:function(a,b,c,e){b=void 0===b?function(){}:b;c=void 0===c?function(){}:c;e=void 0===e?function(){}:e;d.Cache.enabled=!0;var g,h,q,p;for(p in t)t.hasOwnProperty(p)&&a===t[p]&&(g=p);var l=d.Cache.get(g?g:a);if(void 0!==l)return b&&setTimeout(function(){c({loaded:1,total:1});b(l)},0),l;var k=window.URL||window.webkitURL;var m=document.createElementNS("http://www.w3.org/1999/xhtml","img");d.Cache.add(g?g:a,m);var f=function(){k.revokeObjectURL(m.src);b(m)};if(0===a.indexOf("data:"))return m.addEventListener("load",
f,!1),m.src=a,m;m.crossOrigin=void 0!==this.crossOrigin?this.crossOrigin:"";g=new window.XMLHttpRequest;g.open("GET",a,!0);g.responseType="arraybuffer";g.addEventListener("error",e);g.addEventListener("progress",function(a){if(a){var b=a.loaded,e=a.total;a.lengthComputable&&c({loaded:b,total:e})}});g.addEventListener("loadend",function(a){a&&(h=new Uint8Array(a.currentTarget.response),q=new window.Blob([h]),m.addEventListener("load",f,!1),m.src=k.createObjectURL(q))});g.send(null)}},I={load:function(a,
b,c,e){b=void 0===b?function(){}:b;var g=new d.Texture;fa.load(a,function(e){g.image=e;e=0<a.search(/\.(jpg|jpeg)$/)||0===a.search(/^data:image\/jpeg/);g.format=e?d.RGBFormat:d.RGBAFormat;g.needsUpdate=!0;b(g)},c,e);return g}},ha={load:function(a,b,c,e){b=void 0===b?function(){}:b;c=void 0===c?function(){}:c;var g;var h=new d.CubeTexture([]);var q=0;var p={};var l={};a.map(function(a,d){fa.load(a,function(a){h.images[d]=a;q++;6===q&&(h.needsUpdate=!0,b(h))},function(a){p[d]={loaded:a.loaded,total:a.total};
l.loaded=0;g=l.total=0;for(var b in p)g++,l.loaded+=p[b].loaded,l.total+=p[b].total;6>g&&(l.total=l.total/g*6);c(l)},e)});return h}};Y.prototype=Object.assign(Object.create(d.EventDispatcher.prototype),{setContainer:function(a){this.container=a},setScene:function(a){this.scene=a},enumerateDevices:function(){var a=this.devices,b=new Promise(function(b){b(a)});return 0<a.length?b:window.navigator.mediaDevices.enumerateDevices()},switchNextVideoDevice:function(){var a=this.stop.bind(this),b=this.start.bind(this),
...
{constructor:F,updateUniformByFormat:function(a,b){this.format=a;var c=b.repeat.value;b=b.offset.value;var e=this.loffset,g=this.roffset;switch(a){case C.TAB:c.set(1,.5);b.set(0,.5);e.set(0,.5);g.set(0,0);break;case C.SBS:c.set(.5,1),b.set(0,0),e.set(0,0),g.set(.5,0)}},updateTextureToLeft:function(a){a.copy(this.loffset)},updateTextureToRight:function(a){a.copy(this.roffset)}});P.prototype=Object.assign(Object.create(d.Sprite.prototype),{constructor:P,setColor:function(a){this.material.color.copy(a instanceof
...
d=a*Math.PI*2,p=this.color.getStyle(),l=.5*c/h;h=.5*e/h;b.clearRect(0,0,c,e);b.beginPath();0===a?(b.arc(l,h,c/16,0,2*Math.PI),b.fillStyle=p,b.fill()):(b.arc(l,h,c/4-3,-Math.PI/2,-Math.PI/2+d),b.strokeStyle=p,b.lineWidth=3,b.stroke());b.closePath();g.map.needsUpdate=!0},ripple:function(){var a=this,b=this.context,c=this.canvasWidth,e=this.canvasHeight,g=this.material,h=this.rippleDuration,d=performance.now(),p=this.color,l=this.dpr,k=.5*c/l,m=.5*e/l,f=function(){var q=window.requestAnimationFrame(f),
x=(performance.now()-d)/h,n=0<1-x?1-x:0,r=x*c*.5/l;b.clearRect(0,0,c,e);b.beginPath();b.arc(k,m,r,0,2*Math.PI);b.fillStyle="rgba("+255*p.r+", "+255*p.g+", "+255*p.b+", "+n+")";b.fill();b.closePath();1<=x&&(window.cancelAnimationFrame(q),a.updateCanvasArcByProgress(0),a.dispatchEvent({type:"reticle-ripple-end"}));g.map.needsUpdate=!0};this.dispatchEvent({type:"reticle-ripple-start"});f()},show:function(){this.visible=!0},hide:function(){this.visible=!1},start:function(a){this.autoSelect&&(this.dispatchEvent({type:"reticle-start"}),
...
this.unlockHoverElement())}},onDualEyeEffect:function(a){if(this.getContainer()){this.mode=a.mode;a=this.element;var b=this.container.clientWidth/2;var c=this.container.clientHeight/2;a&&(a.left||a.right||(a.left=a.cloneNode(!0),a.right=a.cloneNode(!0)),this.mode===r.CARDBOARD||this.mode===r.STEREO?(a.left.style.display=a.style.display,a.right.style.display=a.style.display,a.style.display="none"):(a.style.display=a.left.style.display,a.left.style.display="none",a.right.style.display="none"),this.translateElement(b,
c),this.container.appendChild(a.left),this.container.appendChild(a.right))}},translateElement:function(a,b){if(this.element._width&&this.element._height&&this.getContainer()){var c=this.container;var e=this.element;var g=e._width/2;var d=e._height/2;var q=void 0!==e.verticalDelta?e.verticalDelta:40;var p=a-g;var l=b-d-q;this.mode!==r.CARDBOARD&&this.mode!==r.STEREO||!e.left||!e.right||a===c.clientWidth/2&&b===c.clientHeight/2?this.setElementStyle("transform",e,"translate("+p+"px, "+l+"px)"):(p=c.clientWidth/
4-g+(a-c.clientWidth/2),l=c.clientHeight/2-d-q+(b-c.clientHeight/2),this.setElementStyle("transform",e.left,"translate("+p+"px, "+l+"px)"),p+=c.clientWidth/2,this.setElementStyle("transform",e.right,"translate("+p+"px, "+l+"px)"))}},setElementStyle:function(a,b,c){b=b.style;"transform"===a&&(b.webkitTransform=b.msTransform=b.transform=c)},setText:function(a){this.element&&(this.element.textContent=a)},setCursorHoverStyle:function(a){this.cursorStyle=a},addHoverText:function(a,b){b=void 0===b?40:b;
...
method:"toggleVideoPlay",data:!this.paused});this.paused=!this.paused;b.update()}});b.paused=!0;b.update=function(a){this.paused=void 0!==a?a:this.paused;this.style.backgroundImage='url("'+(this.paused?t.VideoPlay:t.VideoPause)+'")'};return b},createVideoControlSeekbar:function(){function a(a){a.stopPropagation();d=!0;q=a.clientX||a.changedTouches&&a.changedTouches[0].clientX;k=parseInt(m.style.width)/100;g.container.addEventListener("mousemove",b,{passive:!0});g.container.addEventListener("mouseup",
c,{passive:!0});g.container.addEventListener("touchmove",b,{passive:!0});g.container.addEventListener("touchend",c,{passive:!0})}function b(a){d&&(l=((a.clientX||a.changedTouches&&a.changedTouches[0].clientX)-q)/f.clientWidth,l=k+l,l=1<l?1:0>l?0:l,f.setProgress(l),g.dispatchEvent({type:"panolens-viewer-handler",method:"setVideoCurrentTime",data:l}))}function c(a){a.stopPropagation();d=!1;e()}function e(){g.container.removeEventListener("mousemove",b,!1);g.container.removeEventListener("mouseup",c,
!1);g.container.removeEventListener("touchmove",b,!1);g.container.removeEventListener("touchend",c,!1)}var g=this,d=!1,q,k,l;var m=document.createElement("div");m.style.width="0%";m.style.height="100%";m.style.backgroundColor="#fff";var n=document.createElement("div");n.style.float="right";n.style.width="14px";n.style.height="14px";n.style.transform="translate(7px, -5px)";n.style.borderRadius="50%";n.style.backgroundColor="#ddd";n.addEventListener("mousedown",a,{passive:!0});n.addEventListener("touchstart",
a,{passive:!0});m.appendChild(n);var f=this.createCustomItem({style:{float:"left",width:"30%",height:"4px",marginTop:"20px",backgroundColor:"rgba(188,188,188,0.8)"},onTap:function(a){a.preventDefault();a.stopPropagation();if(a.target!==n){var b=a.changedTouches&&0<a.changedTouches.length?(a.changedTouches[0].pageX-a.target.getBoundingClientRect().left)/this.clientWidth:a.offsetX/this.clientWidth;g.dispatchEvent({type:"panolens-viewer-handler",method:"setVideoCurrentTime",data:b});f.setProgress(a.offsetX/
this.clientWidth)}},onDispose:function(){e();n=m=null}});f.appendChild(m);f.setProgress=function(a){m.style.width=100*a+"%"};this.addEventListener("video-update",function(a){f.setProgress(a.percentage)});f.progressElement=m;f.progressElementControl=n;return f},createMenuItem:function(a){var b=this,c=document.createElement("a");c.textContent=a;c.style.display="block";c.style.padding="10px";c.style.textDecoration="none";c.style.cursor="pointer";c.style.pointerEvents="auto";c.style.transition=this.DEFAULT_TRANSITION;
...
b[c]);return a},dispose:function(){this.barElement&&(this.container.removeChild(this.barElement),this.barElement.dispose(),this.barElement=null)}});var la={tEquirect:{value:new d.Texture},repeat:{value:new d.Vector2(1,1)},offset:{value:new d.Vector2(0,0)},opacity:{value:1}};m.prototype=Object.assign(Object.create(d.Mesh.prototype),{constructor:m,createGeometry:function(a){return new d.BoxBufferGeometry(a,a,a)},createMaterial:function(a,b){a=void 0===a?new d.Vector2(1,1):a;b=void 0===b?new d.Vector2(0,
0):b;var c=d.UniformsUtils.clone(la);c.repeat.value.copy(a);c.offset.value.copy(b);c.opacity.value=0;return new d.ShaderMaterial({fragmentShader:"\n        uniform sampler2D tEquirect;\n        uniform vec2 repeat;\n        uniform vec2 offset;\n        uniform float opacity;\n        varying vec3 vWorldDirection;\n        #include <common>\n        void main() {\n            vec3 direction = normalize( vWorldDirection );\n            vec2 sampleUV;\n            sampleUV.y = asin( clamp( direction.y, - 1.0, 1.0 ) ) * RECIPROCAL_PI + 0.5;\n            sampleUV.x = atan( direction.z, direction.x ) * RECIPROCAL_PI2 + 0.5;\n            sampleUV *= repeat;\n            sampleUV += offset;\n            vec4 texColor = texture2D( tEquirect, sampleUV );\n            gl_FragColor = mapTexelToLinear( texColor );\n            gl_FragColor.a *= opacity;\n            #include <tonemapping_fragment>\n            #include <encodings_fragment>\n        }\n    ",
...
container:b}),a.dispatchEvent({type:"panolens-infospot-focus",method:function(a,b,d){this.dispatchEvent({type:"panolens-viewer-handler",method:"tweenControlCenter",data:[a,b,d]})}.bind(this)}));d.Object3D.prototype.add.call(this,a)},load:function(){this.onLoad()},onClick:function(a){a.intersects&&0===a.intersects.length&&this.traverse(function(a){a.dispatchEvent({type:"dismiss"})})},setContainer:function(a){if(a instanceof HTMLElement)var b=a;else a&&a.container&&(b=a.container);b&&(this.children.forEach(function(a){a instanceof
y&&a.dispatchEvent&&a.dispatchEvent({type:"panolens-container",container:b})}),this.container=b)},onLoad:function(){this.loaded=!0;this.dispatchEvent({type:"load"})},onProgress:function(a){this.dispatchEvent({type:"progress",progress:a})},onError:function(){this.dispatchEvent({type:"error"})},getZoomLevel:function(){return 800>=window.innerWidth?this.ImageQualityFair:800<window.innerWidth&&1280>=window.innerWidth?this.ImageQualityMedium:1280<window.innerWidth&&1920>=window.innerWidth?this.ImageQualityHigh:
1920<window.innerWidth?this.ImageQualitySuperHigh:this.ImageQualityLow},updateTexture:function(a){this.material.uniforms.tEquirect.value=a},toggleInfospotVisibility:function(a,b){b=void 0!==b?b:0;var c=void 0!==a?a:this.isInfospotVisible?!1:!0;this.traverse(function(a){a instanceof y&&(c?a.show(b):a.hide(b))});this.isInfospotVisible=c;this.infospotAnimation.onComplete(function(){this.dispatchEvent({type:"infospot-animation-complete",visible:c})}.bind(this)).delay(b).start()},setLinkingImage:function(a,
b){this.linkingImageURL=a;this.linkingImageScale=b},link:function(a,b,c,e){this.visible=!0;b?(c=void 0!==c?c:void 0!==a.linkingImageScale?a.linkingImageScale:300,e=e?e:a.linkingImageURL?a.linkingImageURL:t.Arrow,e=new y(c,e),e.position.copy(b),e.toPanorama=a,e.addEventListener("click",function(){this.dispatchEvent({type:"panolens-viewer-handler",method:"setPanorama",data:a})}.bind(this)),this.linkedSpots.push(e),this.add(e),this.visible=!1):console.warn("Please specify infospot position for linking")},
reset:function(){this.children.length=0},setupTransitions:function(){this.fadeInAnimation=(new n.Tween(this.material)).easing(n.Easing.Quartic.Out).onStart(function(){this.visible=!0;this.dispatchEvent({type:"enter-fade-start"})}.bind(this));this.fadeOutAnimation=(new n.Tween(this.material)).easing(n.Easing.Quartic.Out).onComplete(function(){this.visible=!1;this.dispatchEvent({type:"leave-complete"})}.bind(this));this.enterTransition=(new n.Tween(this)).easing(n.Easing.Quartic.Out).onComplete(function(){this.dispatchEvent({type:"enter-complete"})}.bind(this)).start();
this.leaveTransition=(new n.Tween(this)).easing(n.Easing.Quartic.Out)},onFadeAnimationUpdate:function(){var a=this.material.opacity,b=this.material.uniforms;b&&b.opacity&&(b.opacity.value=a)},fadeIn:function(a){a=0<=a?a:this.animationDuration;this.fadeOutAnimation.stop();this.fadeInAnimation.to({opacity:1},a).onUpdate(this.onFadeAnimationUpdate.bind(this)).onComplete(function(){this.toggleInfospotVisibility(!0,a/2);this.dispatchEvent({type:"enter-fade-complete"})}.bind(this)).start()},fadeOut:function(a){a=
0<=a?a:this.animationDuration;this.fadeInAnimation.stop();this.fadeOutAnimation.to({opacity:0},a).onUpdate(this.onFadeAnimationUpdate.bind(this)).start()},onEnter:function(){var a=this.animationDuration;this.dispatchEvent({type:"enter"});this.leaveTransition.stop();this.enterTransition.to({},a).onStart(function(){this.dispatchEvent({type:"enter-start"});this.loaded?this.fadeIn(a):this.load()}.bind(this)).start();this.children.forEach(function(a){a.dispatchEvent({type:"panorama-enter"})});this.active=
!0},onLeave:function(){var a=this.animationDuration;this.enterTransition.stop();this.leaveTransition.to({},a).onStart(function(){this.dispatchEvent({type:"leave-start"});this.fadeOut(a);this.toggleInfospotVisibility(!1)}.bind(this)).start();this.dispatchEvent({type:"leave"});this.children.forEach(function(a){a.dispatchEvent({type:"panorama-leave"})});this.active=!1},dispose:function(){function a(b){for(var c=b.geometry,e=b.material,d=b.children.length-1;0<=d;d--)a(b.children[d]),b.remove(b.children[d]);
b instanceof y&&b.dispose();c&&(c.dispose(),b.geometry=null);e&&(e.dispose(),b.material=null)}this.infospotAnimation.stop();this.fadeInAnimation.stop();this.fadeOutAnimation.stop();this.enterTransition.stop();this.leaveTransition.stop();this.dispatchEvent({type:"panolens-viewer-handler",method:"onPanoramaDispose",data:this});a(this);this.parent&&this.parent.remove(this)}});u.prototype=Object.assign(Object.create(m.prototype),{constructor:u,load:function(a){a=a||this.src;if(!a)console.warn("Image source undefined");
else if("string"===typeof a)I.load(a,this.onLoad.bind(this),this.onProgress.bind(this),this.onError.bind(this));else if(a instanceof HTMLImageElement)this.onLoad(new d.Texture(a))},onLoad:function(a){a.minFilter=a.magFilter=d.LinearFilter;a.needsUpdate=!0;this.updateTexture(a);window.requestAnimationFrame(m.prototype.onLoad.bind(this))},reset:function(){m.prototype.reset.call(this)},dispose:function(){var a=this.material.map;d.Cache.remove(this.src);a&&a.dispose();m.prototype.dispose.call(this)}});
R.prototype=Object.assign(Object.create(m.prototype),{constructor:R,createGeometry:function(){var a=new d.BufferGeometry;a.addAttribute("position",new d.BufferAttribute(new Float32Array,1));return a},createMaterial:function(){new d.MeshBasicMaterial({color:0,opacity:0,transparent:!0})}});K.prototype=Object.assign(Object.create(m.prototype),{constructor:K,createMaterial:function(){var a=d.ShaderLib.cube,b=a.fragmentShader,c=a.vertexShader;a=d.UniformsUtils.clone(a.uniforms);a.opacity.value=0;return new d.ShaderMaterial({fragmentShader:b,
vertexShader:c,uniforms:a,side:d.BackSide,transparent:!0,opacity:0})},load:function(){ha.load(this.images,this.onLoad.bind(this),this.onProgress.bind(this),this.onError.bind(this))},onLoad:function(a){this.material.uniforms.tCube.value=a;m.prototype.onLoad.call(this)},dispose:function(){var a=this.material.uniforms.tCube.value;this.images.forEach(function(a){d.Cache.remove(a)});a instanceof d.CubeTexture&&a.dispose();m.prototype.dispose.call(this)}});S.prototype=Object.assign(Object.create(K.prototype),
{constructor:S});z.prototype=Object.assign(Object.create(m.prototype),{constructor:z,isMobile:function(){var a=!1,b=window.navigator.userAgent||window.navigator.vendor||window.opera;if(/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino/i.test(b)||
...
0<=h.duration?h.currentTime/h.duration:0;this.dispatchEvent({type:"panolens-viewer-handler",method:"onVideoUpdate",data:this.videoProgress})}.bind(this));h.addEventListener("ended",function(){c||(this.resetVideo(),this.dispatchEvent({type:"panolens-viewer-handler",method:"updateVideoPlayButton",data:!0}))}.bind(this),!1)},onLoad:function(){m.prototype.onLoad.call(this)},setVideoTexture:function(a){if(a)return a=new d.VideoTexture(a),a.minFilter=d.LinearFilter,a.magFilter=d.LinearFilter,a.format=d.RGBFormat,
this.updateTexture(a),a},reset:function(){this.videoElement=void 0;m.prototype.reset.call(this)},isVideoPaused:function(){return this.videoElement.paused},toggleVideo:function(){var a=this.videoElement;if(a)a[a.paused?"play":"pause"]()},setVideoCurrentTime:function(a){a=a.percentage;var b=this.videoElement;b&&!Number.isNaN(a)&&1!==a&&(b.currentTime=b.duration*a,this.dispatchEvent({type:"panolens-viewer-handler",method:"onVideoUpdate",data:a}))},playVideo:function(){var a=this.videoElement,b=this.playVideo.bind(this),
...
getVideoElement:function(){return this.videoElement},dispose:function(){var a=this.material.map;this.pauseVideo();this.removeEventListener("leave",this.pauseVideo.bind(this));this.removeEventListener("enter-fade-start",this.resumeVideoProgress.bind(this));this.removeEventListener("video-toggle",this.toggleVideo.bind(this));this.removeEventListener("video-time",this.setVideoCurrentTime.bind(this));a&&a.dispose();m.prototype.dispose.call(this)}});Object.assign(Z.prototype,{constructor:Z,setProgress:function(a,
b){if(this.onProgress)this.onProgress({loaded:a,total:b})},adaptTextureToZoom:function(){var a=this.widths[this._zoom],b=this.heights[this._zoom],c=this.maxW,e=this.maxH;this._wc=Math.ceil(a/c);this._hc=Math.ceil(b/e);for(var d=0;d<this._hc;d++)for(var h=0;h<this._wc;h++){var k=document.createElement("canvas");k.width=h<this._wc-1?c:a-c*h;k.height=d<this._hc-1?e:b-e*d;this._canvas.push(k);this._ctx.push(k.getContext("2d"))}},composeFromTile:function(a,b,c){var e=this.maxW,d=this.maxH;a*=512;b*=512;
var h=Math.floor(a/e),k=Math.floor(b/d);this._ctx[k*this._wc+h].drawImage(c,0,0,c.width,c.height,a-h*e,b-k*d,512,512);this.progress()},progress:function(){this._count++;this.setProgress(this._count,this._total);if(this._count===this._total&&(this.canvas=this._canvas,this.panoId=this._panoId,this.zoom=this._zoom,this.onPanoramaLoad))this.onPanoramaLoad(this._canvas[0])},composePanorama:function(){this.setProgress(0,1);var a=this.levelsW[this._zoom],b=this.levelsH[this._zoom],c=this;this._count=0;this._total=
a*b;for(var e=this._parameters.useWebGL,d=0;d<b;d++)for(var h={},k=0;k<a;h={$jscomp$loop$prop$url$2:h.$jscomp$loop$prop$url$2},k++)h.$jscomp$loop$prop$url$2="https://geo0.ggpht.com/cbk?cb_client=maps_sv.tactile&authuser=0&hl=en&output=tile&zoom="+this._zoom+"&x="+k+"&y="+d+"&panoid="+this._panoId+"&nbt&fover=2",function(a){return function(b,d){if(e)var g=I.load(a.$jscomp$loop$prop$url$2,null,function(){c.composeFromTile(b,d,g)});else{var f=new Image;f.addEventListener("load",function(){c.composeFromTile(b,
d,this)});f.crossOrigin="";f.src=a.$jscomp$loop$prop$url$2}}}(h)(k,d)},load:function(a){this.loadPano(a)},loadPano:function(a){var b=this;this._panoClient.getPanoramaById(a,function(a,e){e===google.maps.StreetViewStatus.OK&&(b.result=a,b.copyright=a.copyright,b._panoId=a.location.pano,b.composePanorama())})},setZoom:function(a){this._zoom=a;this.adaptTextureToZoom()}});aa.prototype=Object.assign(Object.create(u.prototype),{constructor:aa,load:function(a){this.loadRequested=!0;(a=a||this.panoId||{},
this.gsvLoader)&&this.loadGSVLoader(a)},setupGoogleMapAPI:function(a){var b=document.createElement("script");b.src="https://maps.googleapis.com/maps/api/js?";b.src+=a?"key="+a:"";b.onreadystatechange=this.setGSVLoader.bind(this);b.onload=this.setGSVLoader.bind(this);document.querySelector("head").appendChild(b)},setGSVLoader:function(){this.gsvLoader=new Z;this.loadRequested&&this.load()},getGSVLoader:function(){return this.gsvLoader},loadGSVLoader:function(a){this.loadRequested=!1;this.gsvLoader.onProgress=
this.onProgress.bind(this);this.gsvLoader.onPanoramaLoad=this.onLoad.bind(this);this.gsvLoader.setZoom(this.getZoomLevel());this.gsvLoader.load(a);this.gsvLoader.loaded=!0},onLoad:function(a){u.prototype.onLoad.call(this,new d.Texture(a))},reset:function(){this.gsvLoader=void 0;u.prototype.reset.call(this)}});var ma={tDiffuse:{value:new d.Texture},resolution:{value:1},transform:{value:new d.Matrix4},zoom:{value:1},opacity:{value:1}};B.prototype=Object.assign(Object.create(u.prototype),{constructor:B,
add:function(a){if(1<arguments.length){for(var b=0;b<arguments.length;b++)this.add(arguments[b]);return this}a instanceof y&&(a.material.depthTest=!1);u.prototype.add.call(this,a)},createGeometry:function(a){return new d.PlaneBufferGeometry(a,.5*a)},createMaterial:function(a){a=void 0===a?this.edgeLength:a;var b=d.UniformsUtils.clone(ma);b.zoom.value=a;b.opacity.value=0;return new d.ShaderMaterial({vertexShader:"varying vec2 vUv;\nvoid main() {\nvUv = uv;\ngl_Position = vec4( position, 1.0 );\n}",
...
this.material.uniforms.transform.value.makeRotationFromQuaternion(this.quatSlerp);!this.dragging&&1-this.quatSlerp.clone().dot(this.quatCur)<this.EPS&&window.cancelAnimationFrame(this.frameId)},reset:function(){this.quatCur.set(0,0,0,1);this.quatSlerp.set(0,0,0,1);this.onUpdateCallback()},updateTexture:function(a){this.material.uniforms.tDiffuse.value=a},onLoad:function(a){this.material.uniforms.resolution.value=this.container.clientWidth/this.container.clientHeight;this.registerMouseEvents();this.onUpdateCallback();
this.dispatchEvent({type:"panolens-viewer-handler",method:"disableControl"});u.prototype.onLoad.call(this,a)},onLeave:function(){this.unregisterMouseEvents();this.dispatchEvent({type:"panolens-viewer-handler",method:"enableControl",data:E.ORBIT});window.cancelAnimationFrame(this.frameId);u.prototype.onLeave.call(this)},onWindowResize:function(){this.material.uniforms.resolution.value=this.container.clientWidth/this.container.clientHeight},onContextMenu:function(){this.dragging=!1},dispose:function(){this.unregisterMouseEvents();
u.prototype.dispose.call(this)}});ba.prototype=Object.assign(Object.create(B.prototype),{constructor:ba,onLoad:function(a){this.updateTexture(a);B.prototype.onLoad.call(this,a)},updateTexture:function(a){a.minFilter=a.magFilter=d.LinearFilter;this.material.uniforms.tDiffuse.value=a},dispose:function(){var a=this.material.uniforms.tDiffuse;a&&a.value&&a.value.dispose();B.prototype.dispose.call(this)}});L.prototype=Object.assign(Object.create(m.prototype),{constructor:L,onPanolensContainer:function(a){this.media.setContainer(a.container)},
onPanolensScene:function(a){this.media.setScene(a.scene)},start:function(){return this.media.start()},stop:function(){this.media.stop()}});M.prototype=Object.assign(Object.create(u.prototype),{constructor:M,onLoad:function(a){var b=a.image;this.stereo.updateUniformByFormat(4===b.width/b.height?C.SBS:C.TAB,this.material.uniforms);this.material.uniforms.tEquirect.value=a;u.prototype.onLoad.call(this,a)},updateTextureToLeft:function(){this.stereo.updateTextureToLeft(this.material.uniforms.offset.value)},
updateTextureToRight:function(){this.stereo.updateTextureToRight(this.material.uniforms.offset.value)},dispose:function(){var a=this.material.uniforms.tEquirect.value;a instanceof d.Texture&&a.dispose();u.prototype.dispose.call(this)}});T.prototype=Object.assign(Object.create(z.prototype),{constructor:T,onLoad:function(a){var b=a.image;this.stereo.updateUniformByFormat(4===b.videoWidth/b.videoHeight?C.SBS:C.TAB,this.material.uniforms);this.material.uniforms.tEquirect.value=a;z.prototype.onLoad.call(this)},
updateTextureToLeft:function(){this.stereo.updateTextureToLeft(this.material.uniforms.offset.value)},updateTextureToRight:function(){this.stereo.updateTextureToRight(this.material.uniforms.offset.value)},dispose:function(){var a=this.material.uniforms.tEquirect.value;a instanceof d.Texture&&a.dispose();z.prototype.dispose.call(this)}});ca.prototype=Object.assign(Object.create(d.EventDispatcher.prototype),{constructor:ca});da.prototype=Object.assign(Object.create(d.EventDispatcher.prototype),{constructor:da});
var ja=function(a){var b=new d.StereoCamera;b.aspect=.5;var c=new d.Vector2;this.setEyeSeparation=function(a){b.eyeSep=a};this.setSize=function(b,c){a.setSize(b,c)};this.render=function(e,d,h){var g=h instanceof M||h instanceof T;e.updateMatrixWorld();null===d.parent&&d.updateMatrixWorld();g&&this.setEyeSeparation(h.stereo.eyeSep);b.update(d);a.getSize(c);a.autoClear&&a.clear();a.setScissorTest(!0);g&&h.updateTextureToLeft();a.setScissor(0,0,c.width/2,c.height);a.setViewport(0,0,c.width/2,c.height);
a.render(e,b.cameraL);g&&h.updateTextureToRight();a.setScissor(c.width/2,0,c.width/2,c.height);a.setViewport(c.width/2,0,c.width/2,c.height);a.render(e,b.cameraR);a.setScissorTest(!1);g&&h.updateTextureToLeft()}};ea.prototype=Object.assign(Object.create(d.EventDispatcher.prototype),{constructor:ea,add:function(a){if(1<arguments.length){for(var b=0;b<arguments.length;b++)this.add(arguments[b]);return this}this.scene.add(a);a.addEventListener&&a.addEventListener("panolens-viewer-handler",this.eventHandler.bind(this));
a instanceof m&&a.dispatchEvent&&a.dispatchEvent({type:"panolens-container",container:this.container});a instanceof L&&a.dispatchEvent({type:"panolens-scene",scene:this.scene});a instanceof m&&(this.addPanoramaEventListener(a),this.panorama||this.setPanorama(a))},remove:function(a){a.removeEventListener&&a.removeEventListener("panolens-viewer-handler",this.eventHandler.bind(this));this.scene.remove(a)},addDefaultControlBar:function(a){if(this.widget)console.warn("Default control bar exists");else{var b=
new J(this.container);b.addEventListener("panolens-viewer-handler",this.eventHandler.bind(this));b.addControlBar();a.forEach(function(a){b.addControlButton(a)});this.widget=b}},setPanorama:function(a){var b=this.panorama;if(a instanceof m&&b!==a){this.hideInfospot();var c=function(){if(b)b.onLeave();a.removeEventListener("enter-fade-start",c)};a.addEventListener("enter-fade-start",c);(this.panorama=a).onEnter()}},eventHandler:function(a){if(a.method&&this[a.method])this[a.method](a.data)},dispatchEventToChildren:function(a){this.scene.traverse(function(b){b.dispatchEvent&&
b.dispatchEvent(a)})},activateWidgetItem:function(a,b){var c=this.widget.mainMenu,e=c.children[0];c=c.children[1];if(void 0!==a){switch(a){case 0:a=e.subMenu.children[1];break;case 1:a=e.subMenu.children[2];break;default:a=e.subMenu.children[1]}e.subMenu.setActiveItem(a);e.setSelectionTitle(a.textContent)}if(void 0!==b){switch(b){case r.CARDBOARD:a=c.subMenu.children[2];break;case r.STEREO:a=c.subMenu.children[3];break;default:a=c.subMenu.children[1]}c.subMenu.setActiveItem(a);c.setSelectionTitle(a.textContent)}},
enableEffect:function(a){if(this.mode!==a)if(a===r.NORMAL)this.disableEffect();else{this.mode=a;var b=this.camera.fov;switch(a){case r.CARDBOARD:this.effect=this.CardboardEffect;this.enableReticleControl();break;case r.STEREO:this.effect=this.StereoEffect;this.enableReticleControl();break;default:this.effect=null,this.disableReticleControl()}this.activateWidgetItem(void 0,this.mode);this.dispatchEventToChildren({type:"panolens-dual-eye-effect",mode:this.mode});this.camera.fov=b+.01;this.effect.setSize(this.container.clientWidth,
this.container.clientHeight);this.render();this.camera.fov=b;this.dispatchEvent({type:"mode-change",mode:this.mode})}},disableEffect:function(){this.mode!==r.NORMAL&&(this.mode=r.NORMAL,this.disableReticleControl(),this.activateWidgetItem(void 0,this.mode),this.dispatchEventToChildren({type:"panolens-dual-eye-effect",mode:this.mode}),this.renderer.setSize(this.container.clientWidth,this.container.clientHeight),this.render(),this.dispatchEvent({type:"mode-change",mode:this.mode}))},enableReticleControl:function(){this.reticle.visible||
...
getNextControlIndex:function(){var a=this.controls,b=a.indexOf(this.control)+1;return b>=a.length?0:b},setCameraFov:function(a){this.camera.fov=a;this.camera.updateProjectionMatrix()},enableControl:function(a){a=0<=a&&a<this.controls.length?a:0;this.control.enabled=!1;this.control=this.controls[a];this.control.enabled=!0;switch(a){case E.ORBIT:this.camera.position.copy(this.panorama.position);this.camera.position.z+=1;break;case E.DEVICEORIENTATION:this.camera.position.copy(this.panorama.position)}this.control.update();
this.activateWidgetItem(a,void 0)},disableControl:function(){this.control.enabled=!1},toggleNextControl:function(){this.enableControl(this.getNextControlIndex())},getScreenVector:function(a){a=a.clone();var b=this.container.clientWidth/2,c=this.container.clientHeight/2;a.project(this.camera);a.x=a.x*b+b;a.y=-(a.y*c)+c;a.z=0;return a},checkSpriteInViewport:function(a){this.camera.matrixWorldInverse.getInverse(this.camera.matrixWorld);this.cameraViewProjectionMatrix.multiplyMatrices(this.camera.projectionMatrix,
this.camera.matrixWorldInverse);this.cameraFrustum.setFromMatrix(this.cameraViewProjectionMatrix);return a.visible&&this.cameraFrustum.intersectsSprite(a)},reverseDraggingDirection:function(){this.OrbitControls.rotateSpeed*=-1;this.OrbitControls.momentumScalingFactor*=-1},addReticle:function(){this.reticle=new P(16777215,!0,this.options.dwellTime);this.reticle.hide();this.camera.add(this.reticle);this.sceneReticle.add(this.camera)},rotateOrbitControlLeft:function(a){this.control.rotateLeft(a)},rotateOrbitControlUp:function(a){this.control.rotateUp(a)},
rotateOrbitControl:function(a,b){this.rotateOrbitControlLeft(a);this.rotateOrbitControlUp(b)},calculateOrbitControlDelta:function(a){if(this.control===this.OrbitControls){var b=this.camera.getWorldDirection(new d.Vector3);var c=b.clone();var e=this.panorama.getWorldPosition(new d.Vector3).sub(this.camera.getWorldPosition(new d.Vector3));a=a.clone();a.add(e).normalize();var g=a.clone();b.y=0;a.y=0;e=Math.atan2(a.z,a.x)-Math.atan2(b.z,b.x);e=e>Math.PI?e-2*Math.PI:e;e=e<-Math.PI?e+2*Math.PI:e;b=Math.abs(c.angleTo(b)+
(0>=c.y*g.y?g.angleTo(a):-g.angleTo(a)));b*=g.y<c.y?1:-1;return{left:e,up:b}}},setControlCenter:function(a){this.control===this.OrbitControls&&(a=this.calculateOrbitControlDelta(a),this.rotateOrbitControl(a.left,a.up))},tweenControlCenter:function(a,b,c){if(this.control===this.OrbitControls){a instanceof Array&&(a=a[0],b=a[1],c=a[2]);b=void 0!==b?b:1E3;c=c||n.Easing.Exponential.Out;var e=this.calculateOrbitControlDelta(a);a=e.left;e=e.up;var d=this.rotateOrbitControlLeft.bind(this),h=this.rotateOrbitControlUp.bind(this),
k={left:0,up:0},m=0,l=0;this.tweenLeftAnimation.stop();this.tweenUpAnimation.stop();this.tweenLeftAnimation=(new n.Tween(k)).to({left:a},b).easing(c).onUpdate(function(a){d(a.left-m);m=a.left}).start();this.tweenUpAnimation=(new n.Tween(k)).to({up:e},b).easing(c).onUpdate(function(a){h(a.up-l);l=a.up}).start()}},tweenControlCenterByObject:function(a,b,c){this.tweenControlCenter(a.getWorldPosition(new d.Vector3),b,c)},onWindowResize:function(a,b){var c=this.container.classList.contains("panolens-container")||
this.container.isFullscreen;if(void 0!==a&&void 0!==b){var d=a;var g=b;this.container._width=a;this.container._height=b}else a=(b=/(android)/i.test(window.navigator.userAgent))?Math.min(document.documentElement.clientWidth,window.innerWidth||0):Math.max(document.documentElement.clientWidth,window.innerWidth||0),b=b?Math.min(document.documentElement.clientHeight,window.innerHeight||0):Math.max(document.documentElement.clientHeight,window.innerHeight||0),d=c?a:this.container.clientWidth,g=c?b:this.container.clientHeight,
this.container._width=d,this.container._height=g;this.camera.aspect=d/g;this.camera.updateProjectionMatrix();this.renderer.setSize(d,g);(this.options.enableReticle||this.tempEnableReticle)&&this.updateReticleEvent();this.dispatchEvent({type:"window-resize",width:d,height:g});this.scene.traverse(function(a){a.dispatchEvent&&a.dispatchEvent({type:"window-resize",width:d,height:g})})},addOutputElement:function(){var a=document.createElement("div");a.style.position="absolute";a.style.right="10px";a.style.top=
